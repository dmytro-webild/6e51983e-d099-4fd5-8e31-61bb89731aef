...
export const metadata: Metadata = {
  title: "Professional Landscaping & Lawn Care in Addison, IL | FB Landscaping",
  description: "Expert landscaping, lawn mowing, and yard maintenance in Addison, IL. 5-star rated local service. Call (312) 823-8720 for your free estimate today.",
  keywords: "landscaping Addison IL, lawn care Addison Illinois, yard maintenance, landscaper near me, professional lawn mowing",
  metadataBase: new URL("https://fblandscaping.com"),
  alternates: {
    canonical: "https://fblandscaping.com",
  },
  openGraph: {
    title: "FB Landscaping - Professional Lawn Care in Addison, IL",
    description: "Transform your yard with expert landscaping services. Call Fernando today for a free estimate.",
    url: "https://fblandscaping.com",
    siteName: "FB Landscaping LLC",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/garden-with-wooden-bench-plants_250224-84.jpg",
  ...
  twitter: {
    ...
    title: "FB Landscaping - Addison, IL",
    description: "Expert lawn care and landscaping services. Get your free estimate now.",
    images: ["http://img.b2bpic.net/free-photo/garden-with-wooden-bench-plants_250224-84.jpg"],
  },
  robots: {
    index: true,
    follow: true,
